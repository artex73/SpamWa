...
system('clear');
echo "[]==================================[]\n";
echo "[] => Author   : MR. ARTEX GAM       []\n";
echo "[] => Nama     : Rebollution             []\n";
echo "[] => Youtube  : Rebollution                  []\n";
echo "[] => Facebook : MR. ARTEX GAM     []\n";
echo "[] => Intagram : @ARTEX GAM      []\n";
echo "[] => github   :https://github.com/Artexgam                 []\n";
echo "[]==================================[]\n";
